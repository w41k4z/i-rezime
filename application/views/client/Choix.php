                            ...
                            <div class="card-body px-0">
                                ...
                                <div class="row">
                                    <div class="col-md-3 choixRegime">
                                        <a class="btn btn-lg btn-danger" href="<?php echo base_url('index.php/IndexController/user_regime')?>?regime=<?=  $perdre[$i]['id']?>" role="button">Choisir</a>
                                    </div>
                    ...
                    <div class="col-sm-6 col-lg-6 mb-3 mb-md-0 h-100 pb-4">
                        <div class="card card-span h-100">
                            ...
                            <div class="card-body px-0">
                                ...
                                <div class="row">
                                    <div class="col-md-3 choixRegime">
                                        <a class="btn btn-lg btn-danger" href="<?php echo base_url('index.php/IndexController/user_regime')?>?regime=<?=  $gagner[$i]['id']?>" role="button">Choisir</a>
                                    </div>
